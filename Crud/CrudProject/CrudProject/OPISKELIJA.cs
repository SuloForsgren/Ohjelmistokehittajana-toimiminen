...
namespace CrudProject
{
    class OPISKELIJA
    {
        ...
        public bool lisaaOpiskelija(String enimi, String snimi, String puh, String email, int onro)
        {
            ...
            String lisayskysely = "INSERT INTO yhteystiedot " + "(etunimi, sukunimi, puhelin, sähköposti, opiskelijanumero) " +
                "VALUES (@en,@sn,@puh,@ema,@onr); ";
            ...
            komento.Parameters.Add("@onr", MySqlDbType.UInt32).Value = onro;
        ...
        {
            MySqlCommand komento = new MySqlCommand();
            String paivityskysely = "update `yhteystiedot` SET `Etunimi` = @enm," + "`Sukunimi` = @snm,`puhelin` = @puh,`sähköposti`= @eml,`opiskelijanumero`= @onr " + "WHERE oid = @oid";
